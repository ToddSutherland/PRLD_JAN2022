...
var addToHome = (function (w) {
	var nav = w.navigator,
		...
		options = {
			...
			expire: 5,					// Minutes to wait before showing the popup again (0 = always displayed)
			message: 'Add me to your Home Screen for better experience!',				// Customize your message or force a language ('' = automatic)
